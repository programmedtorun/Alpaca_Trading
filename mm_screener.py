...
# temp code to remove leading characters
# fin = open("RichardStocks.xlsx - Export.csv")
# fout = open("RichardStocks.xlsx - Export.csv" + '.tmp', 'w')
# lines = fin.readlines()
# for line in lines:
#     fout.write(line[8:])
# fout.close()
# fin.close()
# os.rename("RichardStocks.xlsx - Export.csv" + ".tmp", "RichardStocks.xlsx - Export.csv")
# temp code to remove leading characters
# ______________________________________

file_name = "RichardStocks.xlsx - Export.csv"

# Print table headers
with open(file_name, 'r') as file:
    print("line -->{}".format(file.readline()))
    print("================================================================")

# convert to pandas data frame, using a csv instead of Excel
stock_list = pd.read_csv(file_name)
stock_list = stock_list.head()  # taking only first 5 stocks for readability
